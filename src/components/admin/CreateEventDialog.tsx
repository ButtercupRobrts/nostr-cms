...
import { Calendar, MapPin, Video, Library, Trash2, Plus } from 'lucide-react';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isLiveEvent) {
        ...
        const relaysToUse = [...publishRelays, ...HIVETALK_RELAYS];
        ...
        if (isTimeBased) {
          ...
          // NIP-52: kind 31923 (time-based) requires a 'D' tag with the
          // day-granularity date (YYYY-MM-DD) derived from the start timestamp.
          // This allows date-based indexing by other NIP-52 clients.
