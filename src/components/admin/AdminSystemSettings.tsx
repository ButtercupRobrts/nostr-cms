      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="font-medium flex items-center gap-2">
            ...
            {!isThisUserMaster && role === 'primary' && <Badge variant="default" className="bg-green-600 hover:bg-green-700">Primary</Badge>}
            {!isThisUserMaster && role === 'secondary' && <Badge variant="default" className="bg-blue-600 hover:bg-blue-700">Secondary</Badge>}
