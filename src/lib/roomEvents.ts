...
/**
 * Generate a unique room identifier with a random suffix to avoid collisions.
 */
export function generateUniqueRoomId(name: string): string {
  const baseId = generateRoomId(name);
